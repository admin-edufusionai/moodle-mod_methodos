...
- **Moodle**: 4.1.0 LTS or higher (compatible up to Moodle 4.5+).
- **PHP**: 8.1 or higher.
...
2. Specify your **Methodos Server URL** (e.g. `https://methodos.co.za` for production or `http://localhost:8000` for local development) and click **Save changes**.
